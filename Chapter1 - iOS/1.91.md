...
<img src="./../assets/StaticLibararyStripProcess.png" style="zoom:70%" />
...
<img src="./../assets/DyanmicLibraryStripProcess.png" style="zoom:70%" />

All Symbols

<img src="./../assets/AllSymbolStripProcess.png" style="zoom:70%" />
...
<img src="./../assets/ExternalSymbolStripProcess.png" style="zoom:70%" />
...
<img src="./../assets/AFNetworkingStaticLibFormat.png" style="zoom:40%" />
...
<img src="./../assets/AFNetworkingDynamicLibFormat.png" style="zoom:40%" />
...
<img src="./../assets/StaticLibUseHeaderMapEffect.png" style="zoom:30%" />
...
<img src="./../assets/MachOCalcuateFunAddress.png" style="zoom:40%" />

#### 2. 如何找到全局变量地址

第一步，先用指令查看全局变量的地址值。 `objdump --macho -s main`，可以看到地址值为 `0x100008000` 

<img src="./../assets/GlobalValueAddress.png" style="zoom:40%" />
